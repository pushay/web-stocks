...
export const StockParamList = [
    {name:'name', classes:'stockParam__th stockParam__th--name'},
    {name:'lowest', classes:'stockParam__th stockParam__th--lowest'},
    {name:'highest', classes:'stockParam__th stockParam__th--highest'},
